//Questo file serve per creare ed aprire la connesione tra il server Node.js e il database MySQL
...
connection.connect((err) => {                                       //Questa riga prova effettivamente ad aprire la connessionem         
      {
